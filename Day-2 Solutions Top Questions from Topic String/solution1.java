...
// The best possible solution here could be of a linear time because to ensure that the character is unique 
...
// And then we go through the string the second time, this time we use the hash map as a reference to check 
